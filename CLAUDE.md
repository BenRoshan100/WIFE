...
## Project overview
WIFE is a satirical single-session AI chat app where the user sends one message and a scripted AI delivers a 12–17 message passive-aggressive monologue until the user clicks "I'm sorry." No backend for MVP — all message logic runs client-side in Next.js 14 with TypeScript, deployed to Vercel.
